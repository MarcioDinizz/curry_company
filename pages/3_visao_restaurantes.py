...
def avg_std_time_on_traffic(df1):
    df_aux = df1.loc[:,['City','Time_taken(min)','Road_traffic_density']].groupby(['City','Road_traffic_density']).agg({'Time_taken(min)'
:['mean','std']})
...
with tab1:
    with st.container():
        ...
        with col1:
            ...
            col1.metric('Entreg. únicos',delivery_unique)
        ...
        with col4:
             ...
             col4.metric('STD Entregas', df_aux)
        ...
        with col6:
              ...
              col6.metric('STD Entregas', df_aux)
