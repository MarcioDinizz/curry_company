...
with tab1:
    with st.container():
        ...
        with col1:
            # A maior idade por entregador
            maior_idade = df1.loc[:, 'Delivery_person_Age'].max()
            col1.metric('Maior idade', maior_idade)
        with col2:
           # st.title('Menor Idade') REMOVIDO
    ...
    with st.container():
        ...
        with col2:
            st.markdown('##### Avaliação média por tránsito')
            
            df_avg_ratings_by_traffic = (df1.loc[:,['Delivery_person_Ratings','Road_traffic_density']]                                                 .groupby('Road_traffic_density')
